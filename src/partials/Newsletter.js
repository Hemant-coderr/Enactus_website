...
function Newsletter() {
    ...
    <section>
      <div className=" mx-auto px-4 sm:px-6">
        <div className="pb-5 md:pb-20">
          <div className=" bg-gray-900 rounded py-5 px-4 md:py-16 md:px-12 shadow-2xl overflow-hidden" data-aos="zoom-y-out">
            <div className="relative flex flex-col lg:flex-row justify-between items-center">
            <section class="relative w-3/4 mx-auto  2xl:py-40 px-10 bg-gray-800">
  ...
  <div class="relative container px-4 mx-auto">
    <div class="text-center mb-8">
      <h2 class="mt-10 text-5xl font-bold font-heading text-white">Contact us</h2>
    </div>
...
{/* image */}
                        <img class="h-50 w-full rounded-lg object-cover" src={require('../partials/image/contact_us.jpeg').default} alt=""/>
          </div>
        </div>
        <div class="w-full lg:w-1/2 px-4">
          <div class="py-6 px-8 mb-4 bg-gray-600 rounded-lg">
            <div class="flex items-center">
              <span class="flex items-center justify-center w-12 h-12 mr-8 bg-yellow-500 rounded-lg">
              ...
              <p class="text-lg font-bold text-white">8800169464</p>
            </div>
          </div>
          <div class="py-6 px-8 mb-10 bg-gray-600 rounded-lg">
            <div class="flex items-center">
              <span class="flex items-center justify-center w-12 h-12 mr-8 bg-yellow-500 rounded-lg">
                <svg class="w-5 h-3" width="21" height="14" viewbox="0 0 21 14" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <p class="text-lg font-bold text-white">Enactusshivaji@gmail.com</p>
            </div>
          </div>
          <div class="py-6 px-8">
            <div class="flex">
              <span class="flex-shrink-0 flex items-center justify-center w-12 h-12 mr-8 bg-yellow-500 rounded-lg">
              ...
              <div>
                <div class="pb-4 pr-16 mb-6 border-b border-gray-500">
                  <p class="text-lg font-bold text-white">Enactus Shivaji College,Ring Road,Raja Garden,New Delhi, Delhi 110027</p>
